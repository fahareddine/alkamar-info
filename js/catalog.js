  ...
  function productCard(p, opts = {}, cardIdx = 99) {
    ...
    return `<div class="product-card${_hasBadge ? ' has-badge' : ''}">
      ...
      <div class="card-img">
        ...
        <img src="${imgSrc}" ${srcsetAttr} alt="${esc(p.name || '')}" width="220" height="170" ${isLCP ? 'loading="eager" fetchpriority="high" decoding="async"' : 'loading="lazy" decoding="async"'} onerror="imgFallback(this)">
      </div>
      <div class="card-body">
