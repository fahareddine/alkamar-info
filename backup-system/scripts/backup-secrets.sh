#!/usr/bin/env bash
# ─────────────────────────────────────────────────────────────────────────────
# backup-secrets.sh — Sauvegarde chiffrée des secrets Alkamar Info
#
...
log "═══════════════════════════════════════════════════════════"
log "  Backup Secrets — Alkamar Info"
...
WORK_DIR="$(mktemp -d /tmp/alkamar-secrets-XXXXXX)"
chmod 700 "${WORK_DIR}"
...
# Guide de récupération des secrets — Alkamar Info
...
- Google Drive : Backups/AlkamarInfo/secrets/
...
ARCHIVE_NAME="alkamar-secrets-${TIMESTAMP}"
