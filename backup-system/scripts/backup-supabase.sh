...
ARCHIVE_NAME="alkamar-supabase-${TIMESTAMP}${TAG_LABEL:+-${TAG_LABEL}}"
...
log "═══════════════════════════════════════════════════════════"
log "  Backup Supabase — Alkamar Info"
...
WORK_DIR="$(mktemp -d /tmp/alkamar-supa-XXXXXX)"
...
# Instructions de restauration Supabase — Alkamar Info
