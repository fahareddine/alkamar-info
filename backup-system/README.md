# Système de Sauvegarde Alkamar Info

```
╔══════════════════════════════════════════════════════════════════════╗
║          SYSTÈME DE BACKUP & DISASTER RECOVERY — ALKAMAR INFO       ║
...
║  │  ① GitHub Releases (fahareddine/info-experts-alkamar-backups)  │        ║
║  │  ② Google Drive    (Backups/AlkamarInfo/)              │        ║
...
```bash
# Créer un repo PRIVÉ
gh repo create fahareddine/info-experts-alkamar-backups \
  --private \
  --description "Backups automatiques Alkamar Info"
...
export BACKUP_REPO="fahareddine/info-experts-alkamar-backups"
export GDRIVE_FOLDER="Backups/AlkamarInfo"
