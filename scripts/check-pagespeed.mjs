/**
 * check-pagespeed.mjs — alkamar-info (boutique.info-experts.fr)
...
const URLS = [
  ...
  'https://boutique.info-experts.fr/ordinateurs.html',
];
...
async function main() {
  console.log(`\nPageSpeed Insights — boutique.info-experts.fr`);
  ...
  const lines = [
    `# Rapport PageSpeed — boutique.info-experts.fr`,
    ``,
